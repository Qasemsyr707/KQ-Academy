  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>إدارة الشهادات</h1>
          <p style={{ color: 'rgba(255,255,255,0.6)' }}>سجل بجميع الشهادات المصدرة للطلاب في المنصة</p>
        </div>
      </div>
      ...
      <div style={{ background: '#111', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', overflow: 'hidden' }}>
        {certificates.length === 0 ? (
          <div style={{ padding: '4rem', textAlign: 'center', color: 'rgba(255,255,255,0.5)' }}>
            ...
            <p>لم يتم إصدار أي شهادة حتى الآن.</p>
          </div>
        ) : (
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: 'rgba(255,255,255,0.02)', borderBottom: '1px solid rgba(255,255,255,0.05)', textAlign: 'right' }}>
                ...
                <th style={{ padding: '1.5rem', color: 'rgba(255,255,255,0.5)', fontWeight: 'normal' }}>المدرب</th>
            ...
            <tbody>
              {certificates.map(cert => (
                <tr key={cert.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <td style={{ padding: '1.5rem' }}>{cert.course.instructor.name}</td>
