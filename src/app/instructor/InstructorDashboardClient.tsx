...
import { Users, UploadCloud, Video, FileEdit, Star, TrendingUp, DollarSign, Bot, ShieldCheck, HelpCircle, Wallet } from 'lucide-react';
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem' }}>
            ...
            <div className="glass-card" style={{ padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                <p style={{ fontSize: '0.9rem', opacity: 0.7 }}>تفاعل الطلاب</p>
                <h3 style={{ fontSize: '1.2rem' }}>جيد جداً <span style={{ fontSize: '0.9rem', color: 'var(--success)' }}>↑ 12%</span></h3>
              </div>
            </div>
            <div className="glass-card" style={{ padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                ...
                <h3 style={{ fontSize: '1.2rem' }}>مفعلة بصرامة</h3>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card" style={{ padding: '2rem' }}>
            ...
            {activeCourses.length === 0 ? (
              <p style={{ opacity: 0.7 }}>لم تقم بنشر أي دورة بعد.</p>
            ) : (
